  ...
  return (
    <div>
      <div className="px-4 py-6">
        <h2 className="text-white text-xl md:text-2xl font-bold">Watchlist</h2>
          ...
          >
            {movies.map((movie) => {
              return (
                <div
                  key={movie?.id}
                  className="relative w-[180px] sm:w-[300px] md:h-[200px] h-[200px] cursor-pointer p-2 inline-block"
                >
                  <img
                    alt={movie?.title}
